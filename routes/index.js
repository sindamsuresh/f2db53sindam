...
router.get('/', function (req, res) {
  res.render('index', { title: 'MercedesBenz App', user: req.user });
});
router.get('/register', function (req, res) {
  res.render('register', { title: 'MercedesBenz App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'MercedesBenz App Login', user: req.user });
});
